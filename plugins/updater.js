...
cmd({
  ...
  alias: ["upgrade", "sync"],
  react: '🧠',
  desc: "Update ZEZE TECHbot from GitHub.",
  category: "system",
  filename: __filename
  ...
  try {
    await reply("🔎 Checking for ZEZE TECH updates...");

    const repo = "REY-MD/ZEZE-MD_V5";
    ...
    if (latestHash === currentHash) {
      return reply("✅ You are already using the latest version of ZEZE TECH!");
    }
