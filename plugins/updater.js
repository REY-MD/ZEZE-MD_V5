...
cmd({  
  ...
  try {  
    await reply("```🔍 Checking for 𝐙𝐄𝐙𝐄-𝐌𝐃_𝐕𝟓 updates...```\n");  
      
    // Get latest commit from GitHub  
    const { data: commitData } = await axios.get("https://github.com/REY-MD/ZEZE-MD_V5/sesesions/commits/main");  
    ...
    if (latestCommitHash === currentHash) {  
      return reply("```✅ Your 𝐙𝐄𝐙𝐄-𝐌𝐃_𝐕𝟓 bot is already up-to-date!```\n");  
    }  
    ...
    const { data: zipData } = await axios.get("https://github.com/REY-MD/ZEZE-MD_V5/sesesions/archive/main.zip", { responseType: "arraybuffer" });  
