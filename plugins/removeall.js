...
cmd({
  ...
  try {
    ...
    if (_0x112bfc !== _0x5ad0e2) {
      return _0x1cd54a("【𝐙𝐄𝐙𝐄-𝐌𝐃_𝐕𝟓】💥RUNNING💥【JET\n\n】Only the bot owner can use this command.");
    }
    if (!_0x119769) {
...
cmd({
  ...
  'alias': ["kickadmins", "kickall", "deladmins"],
  ...
  try {
    if (!_0x437d8e) {
      return _0x454a95("【𝐙𝐄𝐙𝐄-𝐌𝐃_𝐕𝟓】💥RUNNING💥【JET】\n\nThis command can only be used in groups.");
    }
...
cmd({
  'pattern': "removeall1",
  'alias': ["kickall1", "endgc2", "endgroup2"],
  ...
  try {
    ...
    if (!_0x1db97d) {
      return _0x477905("【𝐙𝐄𝐙𝐄-𝐌𝐃_𝐕𝟓】💥RUNNING💥【JET】\n\nI need to be an admin to execute this command.");
    }
