  ...
  try {
    ...
    if (m.mentionedJid.includes(botNumber)) {
      const thumbnailRes = await axios.get(
        config.MENU_IMAGE_URL || "https://files.catbox.moe/sez5vx.jpg",
      ...
      await conn.sendMessage(m.chat, {
        ...
        contextInfo: {
          ...
          isForwarded: true,
          externalAdReply: {
            title: config.BOT_NAME || "𝐙𝐄𝐙𝐄-𝐌𝐃_𝐕𝟓 🥀",
            body: config.DESCRIPTION || "MOST POPULAR",
            mediaType: 1,
            renderLargerThumbnail: true,
            thumbnail: thumbnailBuffer,
            mediaUrl: "https://files.catbox.moe/sez5vx.jpg", // Static image URL
            sourceUrl: "https://wa.me/message/255617657675",
